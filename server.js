...
// mongoose.connect('mongodb://localhost:27017/MONGO_CRUD_GUI', { useNewUrlParser: true, useUnifiedTopology: true })
//     .then(() => console.log('Connected to MongoDB'))
//     .catch(err => console.error('Error connecting to MongoDB', err));


// MongoDB connection atlas cloud
mongoose.connect('mongodb+srv://Test1234:Test1234@cluster0.uuaus.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', { useNewUrlParser: true, useUnifiedTopology: true })
    .then(() => console.log('Connected to MongoDB'))
    .catch(err => console.error('Error connecting to MongoDB', err));
